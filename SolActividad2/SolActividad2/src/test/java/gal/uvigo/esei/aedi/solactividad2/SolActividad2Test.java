...
public class SolActividad2Test {
    ...
    public void testConstruir() {
        ...
        ArbolBinario<Character> result = SolActividad2.construir("3","3");
    ...
    public void testConstruir2() {
        ...
        ArbolBinario<Character> result = SolActividad2.construir("7635218", "3657128");
        boolean eq = identicos(expResult, result);
        assertTrue(eq);
    }
    ...
    public void testVacioEsCamino() {
        ...
        boolean result = SolActividad2.esCamino(vacioChar, "");
    ...
    public void testNoEsCamino() {
        ...
        boolean result = SolActividad2.esCamino(arbolCamino, "5");
        assertEquals(expResult, result);
    }
    @Test
    public void testEsCamino() {
        ...
        boolean expResult = true;
        boolean result = SolActividad2.esCamino(arbolCamino, "763");
        assertEquals(expResult, result);
    }
    @Test
    public void testEsCamino2() {
        ...
        boolean expResult = true;
        boolean result = SolActividad2.esCamino(arbolCamino, "721");
        assertEquals(expResult, result);
    }
...
//        Character result = SolActividad2.getPadre(arbolCamino, '4');
//        assertEquals(expResult, result);
//    }
//    
//    @Test
...
//        Character expResult = null;
//        Character result = SolActividad2.getPadre(arbolCamino, '7');
//        assertEquals(expResult, result);
//    }
//    @Test
...
//        Character result = SolActividad2.getPadre(arbolCamino, '2');
//        assertEquals(expResult, result);
//    }
//    @Test
...
//        Character result = SolActividad2.getPadre(arbolCamino, '1');
//        assertEquals(expResult, result);
//    }
